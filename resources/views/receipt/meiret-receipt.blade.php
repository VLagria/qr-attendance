...
<body>
    <div class="container">
        ...
        <div class="content-body">
            <p><strong>Student ID:</strong> {{ $merit->display_id }}</p>
            <p><strong>Name:</strong> {{ $merit->last_name }}, {{ $merit->first_name }} {{ $merit->middle_name }}</p>
            <p><strong>Year Level:</strong> {{ $merit->year_level }}</p>
            <p><strong>Date:</strong> {{ $merit->date }}</p>
            <p><strong>Time:</strong> {{ date("h:i A", strtotime($merit->time)) }}</p>
        </div>
    </div>
    <div class="footer">
